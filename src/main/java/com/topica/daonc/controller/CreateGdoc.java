...
public class CreateGdoc {
    ...
    public CreateGdoc() throws IOException, GeneralSecurityException {
    }

    @GetMapping("/create_gdoc")
    public DriveFile createGdoc(@RequestParam String title) throws IOException {
        String idFile = "";
        String titleFile = "";
        DriveFile driveFile = null;

        if (title.isEmpty()) {
            titleFile = "VCRXUNIdoc:template";
        } else {
            titleFile = "VCRXUNIdoc:" + title;
        }
